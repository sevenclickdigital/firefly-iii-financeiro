...
return [
    ...
    'edit'                                                => 'Editar',
    'loading'                                             => 'Baixar',
    'transaction_journal_id'                              => 'ID do livro de transação',
    'delete'                                              => 'Apagar',
    'split'                                               => 'Dividir',
    ...
    'previous_year'                                       => 'Ano Anterior (:year)',
    ...
    'pref_anonymous'                                      => 'Valores ocultos',
    'pref_anonymous_help'                                 => 'Por privacidade e anonimato, você pode fazer o Firefly III ocultar todas as quantidades. Isso não irá ocultar as quantidades nas caixas de edição, mas o resto está oculto. Você também pode alternar isso com o pequeno ícone "olho" na barra superior.',
    'pref_anonymous_label'                                => 'Ocultar valores',
    ...
    'exchange_rate_instructions'                          => 'A conta de ativo "@name" só aceita transações em @primary_currency. Se, ao invés disso, você gostaria de usar @foreign_currency, certifique-se que o valor em @primary_currency é conhecido também:',
    ...
    'bad_date_transaction'                                => 'Firefly III detectou que você tem transações a partir de antes do ano de 1970. Por favor, corrija essas transações o mais breve possível.',
    'anonymous_warning_on'                                => 'Para sua privacidade, todos os valores agora são exibidos como "zero". Aviso: as caixas de texto ainda podem mostrar as quantidades originais!',
    'anonymous_warning_off'                               => 'Os valores serão visíveis novamente. Por favor, fique atento ao seu redor.',
    ...
    'webhook_response_BUDGET'                             => 'Detalhes de orçamento',
    ...
    'rule_run_after_creation'                             => 'Se você marcar esta caixa, terá a oportunidade de executar a regra após ela ter sido criada.',
    'rule_run_after_edit'                                 => 'Se você marcar esta caixa, você terá a oportunidade de executar a regra após ela ter sido atualizada.',
    ...
    'rule_trigger_not_tag_contains'                       => 'Nenhuma tag contém ":trigger_value"',
    ...
    'rule_trigger_any_external_url_choice'                => 'Tem uma (qualquer) URL externa ',
    'rule_trigger_any_external_id'                        => 'A transação tem um ID externo (qualquer)',
    'rule_trigger_any_external_id_choice'                 => 'Tem um (qualquer) ID externo ',
    'rule_trigger_no_external_url_choice'                 => 'Não tem URL externa',
    'rule_trigger_no_external_url'                        => 'A transação não tem URL externa',
    'rule_trigger_no_external_id_choice'                  => 'Não tem nenhum ID externo',
    ...
    'rule_trigger_not_description_contains'               => 'Descrição não contém ":trigger_value"',
    ...
    'pref_convert_to_primary'                             => 'Exibir valores em sua moeda principal',
    'pref_convert_to_primary_help'                        => 'Esta opção fará o Firefly III tentar exibir e mostrar sua moeda principal no maior número de lugares possível, convertendo valores quando necessário. Isso sacrifica a precisão pela facilidade de utilização, porque a conversão nem sempre é precisa. Verifique que o Firefly III tem as taxas de conversão necessárias na página "taxas de câmbio".',
    'pref_convert_primary_help'                           => 'Mostrar valores principais',
    ...
    'temp_administrations_introduction_edit'              => 'Atualmente, você pode apenas definir a "moeda principal" da administração financeira padrão. Isso substitui a configuração de "moeda padrão". Esta definição está agora ligada à administração financeira e pode diferir por administração.',
    ...
    'currencies_switch_default'                           => 'Você pode alterar a moeda principal da sua administração na página "Administração Financeira".',
    ...
    // bills:
    'left_to_pay_active_bills'                            => 'Assinaturas ativas, esperadas e ainda não pagas',
    'left_to_pay_lc'                                      => 'Restante a pagar',
    'less_than_expected'                                  => '',
    'more_than_expected'                                  => 'Mais do que o esperado',
    ...
    'subscr_expected_x_times'                             => 'Espera-se pagar {{amount}} {{times}} vezes nesse período',
    'not_or_not_yet'                                      => 'Não (ainda)',
    'visit_bill'                                          => 'Visite a assinatura ":name" no Firefly III',
    'visit_bills'                                         => 'Visitar assinaturas no Firefly III',
    ...
    'stored_new_accounts_new_user'                        => 'Oba! Suas novas contas foram criadas.',
    ...
    // reports:
    'quick_link_needs_accounts'                           => 'Para gerar relatórios, você precisa adicionar pelo menos uma conta de ativo no Firefly III.',
    ...
    'config_security'                                     => 'Configuração de segurança',
    'config_features'                                     => 'Funcionalidades habilitadas',
    'config_tech'                                         => 'Funcionalidades relacionados à tecnologia',
    'config_external_connections'                         => 'Configurações de privacidade (conecta-se à internet)',

    'setting_enable_exchange_rates'                       => 'Habilitar taxas de câmbio',
    'setting_enable_exchange_rates_explain'               => 'Firefly III consegue calcular as taxas de câmbio para você.',
    'setting_use_running_balance'                         => 'Usar a coluna "balanço atual" e seus dados',
    'setting_use_running_balance_explain'                 => 'Firefly III pode calcular o atual saldo ativo para você e exibir isso em vários lugares. Ainda é um pouco experimental, então desabilitado por padrão. Você pode precisar reiniciar o contêiner ou disparar o comando inicial manualmente (veja a documentação).',
    'setting_enable_external_map'                         => 'Usar mapa externo',
    'setting_enable_external_map_explain'                 => 'O Firefly III usa um serviço externo para exibir localizações. Está bem?',
    'setting_enable_external_rates'                       => 'Baixar taxas de câmbio da web',
    'setting_enable_external_rates_explain'               => 'O Firefly III pode baixar as taxas de câmbio das moedas nativas. Isso requer que o cron job esteja funcionando.',
    'setting_allow_webhooks'                              => 'Permitir webhooks',
    'setting_allow_webhooks_explain'                      => 'Autorizar o Firefly III a acionar webhooks?',
    'setting_valid_url_protocols'                         => 'Protocolos de URL permitidos',
    'setting_valid_url_protocols_explain'                 => 'Firefly III só permite que urls tenham protocolos padrão como https e ftp, etc. Se você é um técnico você pode querer autorizar os outros também.',
    ...
    'recurring_ndom_skip'                                 => 'A cada :skip(º) mês, no(a) :dayOfMonth(º/ª) :weekday',
    ...
    // audit log entries
    'incomplete_ale'                                      => 'Nem todos os eventos são gravados como entradas de registro de auditoria.',
