...
return [
    ...
    // mfa
    'profile_mfa'            => 'Autenticação de múltiplos fatores',
    'mfa_enableMFA'          => 'Habilitar a autenticação de múltiplos fatores',
    'mfa_backup_codes'       => 'Códigos de backup',
    'mfa_disableMFA'         => 'Desativar autenticação de múltiplos fatores',

    // notifications
    'notification_index'     => 'Notificações do proprietário',

    // exchange rates
    'exchange_rates_index'   => 'Taxa de câmbio',
    'exchange_rates_rates'   => 'Taxa de câmbio entre :from e :to (e vice-versa)',
];
