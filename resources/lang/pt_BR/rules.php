...
return [
    ...
    'no_destination'                              => 'Não foi possível encontrar ou criar a conta de destino ":name"',
    ...
    'both_link_piggy'                             => 'As contas da transação estão vinculada ao cofrinho, então nenhuma ação será tomada',
    'already_linked'                              => 'Esta transação já está vinculada ao cofrinho ":name"',
    ...
    'cannot_remove_zero_piggy'                    => 'Não é possível remover o valor zero do cofrinho ":name"',
    'cannot_remove_from_piggy'                    => 'Não é possível retirar :amount do cofrinho ":name"',
    'cannot_add_zero_piggy'                       => 'Não é possível adicionar a quantidade zero ao cofrinho ":name"',
    'cannot_add_to_piggy'                         => 'Não é possível adicionar :amount ao cofrinho ":name"',
];
